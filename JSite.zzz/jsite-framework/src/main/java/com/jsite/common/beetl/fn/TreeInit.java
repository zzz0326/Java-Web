	...
	private String initMenuTree(List<Menu> menuList) {
		...
		for (Menu menu : menuList) {
			...
			if(menu.getParent().getId().equals("0") && menu.getIsShow().equals("1")) {// 一级菜单isEmpty(menu.parentId)
				...
				htmlStr.append("<a title='" + i18n(menu.getName()) + "' href='javascript:' data-href='" + href + "' class='addTabPage'>\n");
				htmlStr.append("<i class='" + menu.getIcon() + "'></i> <span>&nbsp;" + i18n(menu.getName()) + "</span> \n");
		...
		if(href.equals("blank")) {
			...
			for(Menu menu1 : menuList) {
				if(menu1.getParent().getId().equals(menu.getId()) && menu1.getIsShow().equals("1")) {// 四级菜单
					...
					htmlStr2.append(href.equals("blank")?"<a title='" + i18n(menu1.getName()) + "' href='javascript:' data-href='" + href + "' class='addTabPage'>\n":"");
					htmlStr2.append(href.equals("blank")?"<i class='" + menu1.getIcon() + "'></i>&nbsp;" + i18n(menu1.getName()) + " \n":"");
					htmlStr2.append(href.equals("blank")?rightContainer:"");
					htmlStr2.append(href.equals("blank")?"</a>\n":"");

					htmlStr2.append(href.equals("blank")?"":"<li class='treeview'><a title='" + i18n(menu1.getName()) + "' href='javascript:' data-href='" + href + "' class='addTabPage'><i class='" + menu1.getIcon() + "'></i>&nbsp;" + i18n(menu1.getName()) + "</a></li>\n");
